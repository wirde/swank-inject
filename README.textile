...
Show options:
> java -cp swank-inject-0.0.2-SNAPSHOT-standalone.jar com.wirde.inject.Main -h
...
Start injector:
> java -cp swank-inject-0.0.2-SNAPSHOT-standalone.jar com.wirde.inject.Main -host localhost -port 7777 -urls file:///home/wirde/swank-inject-0.0.2-SNAPSHOT-standalone.jar -instances com.wirde.MySingleton
